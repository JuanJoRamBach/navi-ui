...
import {
  ...
  DeviceCameraIcon, PlayIcon, CommentIcon, LinkIcon, CheckCircleFillIcon, PlusIcon,
} from "@primer/octicons-react";
import { spacing, radius, fontSize, fontWeight, neutral, fontFamily } from "./tokens";
import {
  listMCPConnections, createMCPConnection, connectMCP, deleteMCPConnection,
  type MCPConnection, type MCPTransport,
} from "./mcpConnections";
...
function ConnectForm({ serviceLabel, credentialsUrl, onCancel, onSubmit, submitting, error }: {
